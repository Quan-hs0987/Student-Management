...
class ReportController extends Controller
{
    ...
    public function report1($pid){
        ...
        // Kiểm tra xem payment->enrollment có tồn tại không trước khi truy cập vào trường
        if($payment->enrollment) {
            $print.= "<p> Student Name: <b> ". $payment->enrollment->student->name . "</b></p>";
            
            // Kiểm tra xem payment->enrollment->batch có tồn tại không trước khi truy cập vào trường
